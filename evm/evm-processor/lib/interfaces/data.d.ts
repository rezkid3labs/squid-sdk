import { EvmBlockHeader, EvmLog, EvmStateDiff, EvmStateDiffBase, EvmTraceBase, EvmTraceCallAction, EvmTraceCallResult, EvmTraceCreateAction, EvmTraceCreateResult, EvmTraceRewardAction, EvmTraceSuicideAction, EvmTransaction } from './evm';
type Simplify<T> = {
    [K in keyof T]: T[K];
} & {};
...
export type BlockHeader<F extends FieldSelection = {}> = Simplify<{
    id: string;
} & Pick<EvmBlockHeader, BlockRequiredFields> & Select<EvmBlockHeader, GetFields<F, 'block'>>>;
